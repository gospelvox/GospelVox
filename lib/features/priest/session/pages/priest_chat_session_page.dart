...
class PriestChatSessionPage extends StatelessWidget {
  ...
  void _onEnded(BuildContext context, ChatSessionEnded state) {
    ...
    // watchdog_timeout, external — routes to the same summary page so
    // the priest always sees the identical full breakdown (duration,
    // gross, commission, net), no matter how the session ended.
    context.go(
